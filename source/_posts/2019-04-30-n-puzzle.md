...
![](https://cdn.jsdelivr.net/gh/yozora7/garage@master/n-puzzle/res/1.jpg)
...
完整的 Python A* 程序在[这里](https://github.com/yozora7/garage/blob/master/n-puzzle/python/main.py)。参考了 [AIMA 的配套代码](https://github.com/aimacode/aima-python/blob/master/search.py)。
...
完整的 C++ 程序在[这里](https://github.com/yozora7/garage/tree/master/n-puzzle)。
